    ...
    <div class="content-main__container">
        <div class="products-columns">
            ...
            <div class="products-columns__item">
                ...
                <div class="products-columns__item__description"><span class="products-price">{{ $product->price }} руб</span><input type="button" class="btn btn-blue open-popup" data-id="{{ $product->id }}" value="Купить"></div>
            </div>
            @endforeach
        </div>
    </div>
